...
def main():
    ...
    plt.savefig('C:/Users/user/awesome-hand-pose-estimation/evaluation/figures/{}_error.png'.format(dataset))
    ...
    if dataset == 'msra':
        ...
        msra_viewpoint = get_msra_viewpoint('C:/Users/user/awesome-hand-pose-estimation/evaluation/groundtruth/{}/{}_angle.txt'.format(dataset, dataset))
        # yaw
        ...
        plt.savefig('C:/Users/user/awesome-hand-pose-estimation/evaluation/figures/{}_yaw_pitch.png'.format(dataset))
